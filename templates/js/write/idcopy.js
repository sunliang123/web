$(function(){
	var idcopyImg = window.location.search;
	var frontImage = idcopyImg.substring(idcopyImg.indexOf('=')+1, idcopyImg.indexOf('&'));
	var backImg= idcopyImg.substring(idcopyImg.lastIndexOf('=')+1);
	
	$("#frontImage img").attr('src','http://idcard.zxcioc.com/'+ frontImage);
	$("#backImg img").attr('src','http://idcard.zxcioc.com/'+ backImg);
